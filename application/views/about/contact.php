              ...
              <form action="#" method="post" class="cform-form">
                ...
                <div class="row">
                  <div class="span12"> <span class="message">
                    <textarea name="message" class="cform-textarea" cols="40" rows="10" title="drop us a line." placeholder="Send us your feedback or a new place which you would like to add to the list."></textarea>
                    </span> </div>
                </div>
                <div>
